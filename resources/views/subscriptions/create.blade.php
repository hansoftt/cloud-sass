                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            @endif
                            <form method="POST" action="{{ route('cloud-sass.subscriptions.store') }}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" class="form-control" value="{{ old('validity') }}"
                                    ...
                                    <div class="col-md-2 align-content-end">
                                        <button type="submit" class="btn btn-primary mt-4">Create Subscription</button>
                                    </div>
                                </div>
                            </form>
                        </div>
